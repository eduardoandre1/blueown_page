...
import video from './../../../videos/blueowpage_video1.mp4'
...
function VideoBlock() {
    ...
    return (
        <SectionStyle>
            ...
            <h2 className={show}> O que podemos fazer por você? </h2>
            <p className={show}>Estamos aqui para ajudar a divulgar sua marca de maneira eficaz. </p>
        </SectionStyle>)
}
